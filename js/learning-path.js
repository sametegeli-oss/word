...
(function WMLearningPathExcel(){
  ...
  function parseSheet(wb){
    ...
    // başlık -> normalize map
    var sample = rows[0];
    var keymap = {}; // normalized -> gerçek anahtar
    ...
    var cGr   = pick(keymap,['GrammarStructure','Grammar','Gramer','Pattern']);
    ...
    rows.forEach(function(r, idx){
      var en = cEN!=null ? String(r[cEN]||'').trim() : '';
      if (!en) return;
      out.push({
        ...
        sentence: en,
        sentenceTr: cTR!=null ? String(r[cTR]||'').trim() : '',
