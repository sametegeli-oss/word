...
(function WMLearningPathUI(){
  ...
  function injectCSS(){
    ...
    /* learning path açıkken floating Mining/Ses/Panel/Araçlar butonlarını gizle */
    body.wm-path-active #ffFabs, body.wm-path-active #wmToolsBtn { display:none !important; }
  ...
  P.practicePodcast = function(){
    ...
    try {
      ...
      setTimeout(function(){
        ...
        if(window.showToast) window.showToast('🎙️ Podcast', lvs.cefr+' seviyesi hazır');
      }, 400);
