...
(function WMLearningPathReinforce(){
    ...
    try {
      ...
      setTimeout(function(){
        try {
          ...
          if(window.showToast) window.showToast('🎧 Shadowing', pool.length+' cümle yüklendi');
        } catch(e){}
      }, 320);
  ...
  P.practiceStory = function(){
    ...
    try {
      ...
      setTimeout(function(){
        // konu alanı varsa modül konusunu yaz
        ...
        if(window.showToast) window.showToast('📖 Hikaye', topic+' konusu hazır');
      }, 300);
  ...
  P.practicePodcast = function(){
    ...
    try {
      ...
      setTimeout(function(){
        ...
        if(t){ if('value' in t) t.value=topic; else t.textContent=topic; }
        if(window.showToast) window.showToast('🎙️ Podcast', topic+' konusu hazır');
      }, 300);
  ...
  P.genSimilar = function(){
    ...
    var sys='You are an English teacher for Turkish A1 learners. Generate NEW example sentences '
      +'using the SAME grammar pattern as the given sentence. Keep them simple (A1). '
  ...
  P.aiTest = function(){
    ...
    var topic=l.grammar||l.module;
    var sys='You are an English test generator for Turkish A1 learners. '
      +'Create exactly 5 multiple-choice questions testing this grammar topic. '
