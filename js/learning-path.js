console.log('🗺️ learning-path.js YÜKLENDİ — sürüm v6');
...
(function WMLearningPathUI(){
  ...
  function injectCSS(){
    ...
    #sc-path .wp-scene{ position:relative; border-radius:18px; overflow:hidden; min-height:320px;
    ...
    @media (max-width:420px){
      ...
      #sc-path .wp-scene{ min-height:260px; }
