...
(function(){
  ...
  function injectLayoutGuard(){
    ...
    var css = ''
      ...
      + '#lcPfcProblemCards{display:grid !important;grid-template-columns:repeat(2,minmax(0,1fr)) !important;gap:12px !important;margin-top:10px !important;width:100% !important;}'
      + '#lcPfcProblemCards>.pfc-sound-card{min-width:0 !important;}'
      + '@media(max-width:560px){#lcPfcProblemCards{grid-template-columns:1fr !important;}}'
      + '.pfc-art-row{display:grid !important;grid-template-columns:1fr 1fr !important;gap:8px !important;align-items:stretch !important;margin:10px 0 !important;}'
