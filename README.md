...
- Yüzen Mining/Ses düğmeleri kaldırıldı.
- Hızlı İşlemler kartı eklendi.
- Mobil düğme çakışmaları temizlendi.


## Duplicate Button Cleanup
- Hızlı İşlemler kartı kaldırıldı.
- Eski Mining / Ses / Panel / Shadow launcherları kaldırıldı.
- Her özellik sadece kendi ekranından erişilecek şekilde sadeleştirildi.
