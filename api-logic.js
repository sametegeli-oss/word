...
async function explainWord(word, containerId) {
  // Scroll sırasında engelle
  if (isScrolling) {
    console.log('🚫 Scroll sırasında modal engellendi');
    return;
  }
  ...
  modal.innerHTML = `
    ...
    ">
      ...
      <div style="display: flex; flex-direction: column; gap: 8px;">
        ...
        <button onclick="closeModal();showScreen('sc-sent')" style="
          width: 100%;
          padding: 12px;
